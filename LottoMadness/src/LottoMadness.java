...
// set up row 2
		...
		JLabel numberLabel = new JLabel("Your picks: ", JLabel.RIGHT);
...
// set up row 4
		...
		JLabel got4Label = new JLabel("4 to 6: " , JLabel.RIGHT);
		JTextField got4 = new JTextField("0");
		JLabel got5Label = new JLabel("5 to 6: " , JLabel.RIGHT);
		JTextField got5 = new JTextField("0");
		JLabel got6Label = new JLabel("6 to 6: " , JLabel.RIGHT);
