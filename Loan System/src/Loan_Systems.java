	...
	private void initialize() {
		...
		btnLoanCalculator.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				double monthlyInterestRate = AmountOfLoan * (InterestRate/100) / NumberOfYears;
				//-------------------------------------------------------------------------------
				double monthlyPayment =  monthlyInterestRate + (AmountOfLoan / (NumberOfYears * 12));
				...
				totalPayment = AmountOfLoan * Math.pow((1 + (InterestRate/100) / 12),NumberOfYears*12);
				monthlyPayment = totalPayment / (NumberOfYears*12);
